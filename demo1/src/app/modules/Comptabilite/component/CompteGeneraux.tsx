...
const CompteGSchema= Yup.object().shape({
    compteG:Yup.string()
...
export function CompteGeneraux(){
    ...
    const formik = useFormik({
        initialValues,
        validationSchema: CompteGSchema,
         ...
         <div className='card'>
                ...
                <div className='card-header border-0 pt-5'>
                    <h3 className='card-title align-items-start flex-column'>
                        <span className='card-label fw-bold fs-3 mb-1'>Compte Generaux</span>
                    </h3>
                        ...
                        <table className='table align-middle gs-0 gy-4'>
                            ...
                            <thead>
                                <tr className='fw-bold text-muted bg-light'>
                                    ...
                                    <th className='min-w-200px'>Classement</th>
            ...
            <div className="d-flex justify-content-center align-items-center fixed-top" style={{ zIndex: 999 }}>
                <Alert className="w-50"
                    ...
                    <div className='card-header border-0 pt-5'>
                        ...
                        <button className='btn btn-light-primary' onClick={() => handleViewChange('Analytique')}>Analytique</button>
                        <button className='btn btn-light-primary' onClick={() => handleViewChange('Parametres')}>Parametres</button>
                    </div>
                    {view === 'Identification' && (
                        <div className="card bg-light">
                                    ...
                                    <div className='row'>
                                        <div className='col-xl-6'>
                                            <div className='fv-row mb-8'>
                                                <label className='form-label fw-bolder text-dark fs-6'>Compte Generale </label>
                                                <input
                                                    placeholder=''
                                                    type='text'
                                                    autoComplete='off'
                                                    {...formik.getFieldProps('compteG')}
                                                    className={clsx(
                                                        'form-control bg-transparent',
                                                        {
                                                            'is-invalid': formik.touched.compteG && formik.errors.compteG,
                                                        },
                                                        {
                                                            'is-valid': formik.touched.compteG && !formik.errors.compteG,
                                                        }
                                                    )}
                                                />
                                                {formik.touched.compteG && formik.errors.compteG && (
                                                    <div className='fv-plugins-message-container'>
                                                        <div className='fv-help-block'>
                                                            <span role='alert'>{formik.errors.compteG}</span>
                                                        </div>
                                                    </div>
                                                )}
                                            </div>
                            ...
                            <div className='card '>
                                <div className='card-header border-0 pt-5'>
                                    <h3 className='card-title align-items-start flex-column'>
                                        <span className='card-label fw-bold fs-3 mb-1'>Caractéristiques</span>
                                    </h3>
                                </div>
                                <div className="card-body">
                                    <div className='row'>
                                        ...
                                        <div className='col-xl-6'>
                                            <div className='fv-row mb-8'>
                                                <label className='form-label fw-bolder text-dark fs-6'>Nature de compte</label>
                                                <select className='form-select bg-transparent'  >
                                                    <option selected disabled hidden value=""></option>
                                                    <option>jour</option>
                                                    <option>heure</option>
                                        ...
                                        <div className='col-xl-6'>
                                            <div className='fv-row mb-8'>
                                                <label className='form-label fw-bolder text-dark fs-6'>Report a Nouveau</label>
                                                <select className='form-select bg-transparent'  >
                                                    <option selected disabled hidden value=""></option>
                                                    <option>jour</option>
                                                    <option>heure</option>
                                        ...
                                        <div className='col-xl-6'>
                                            <div className='fv-row mb-8'>
                                                <label className='form-label fw-bolder text-dark fs-6'>Code taxe attache</label>
                                                <select className='form-select bg-transparent'  >
                                                    <option selected disabled hidden value=""></option>
                                                    <option>jour</option>
                                                    <option>heure</option>
