                ...
                <div className='col-xl-6'>
                  ...
                  <div className='fv-row mb-8'>
                    ...
                    <input
                      ...
                      type='text'
                      autoComplete='off'
                      {...formik.getFieldProps('GroupeCode')}
                      className={clsx(
                        'form-control bg-transparent',
                        {
                          'is-invalid': formik.touched.GroupeCode && formik.errors.GroupeCode,
                        },
                        {
                          'is-valid': formik.touched.GroupeCode && !formik.errors.GroupeCode,
                        }
                      )}
                    />
                  ...
                  <div className='fv-row mb-8'>
                    ...
                    <input
                      ...
                      type='text'
                      autoComplete='off'
                      {...formik.getFieldProps('GroupeName')}
                      className={clsx(
                        'form-control bg-transparent',
                        {
                          'is-invalid': formik.touched.GroupeName && formik.errors.GroupeName,
                        },
                        {
                          'is-valid': formik.touched.GroupeName && !formik.errors.GroupeName,
                        }
                      )}
                    />
                  ...
                  <div className='fv-row mb-8'>
                    <label className='form-label fw-bolder text-dark fs-6'>Groupe Funtion</label>
                    <input
                      placeholder='Groupe Function'
                      type='text'
                      autoComplete='off'
                      {...formik.getFieldProps('GroupeType')}
                      className={clsx(
                        'form-control bg-transparent',
                        {
                          'is-invalid': formik.touched.GroupeType && formik.errors.GroupeType,
                        },
                        {
                          'is-valid': formik.touched.GroupeType && !formik.errors.GroupeType,
                        }
                      )}
                    />
