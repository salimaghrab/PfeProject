...
const GestionColisageSchema = Yup.object().shape({
    code: Yup.string()
        .min(3, 'min 3 '),
    Intitule: Yup.string()
        .min(3, 'min 3 '),
})
export function TypeColisage(){

    const [, setLoading] = useState(false)
    const formik = useFormik({
        initialValues,
        validationSchema: GestionColisageSchema,
        ...
        <div className="card">
                ...
                <div className='card-header border-0 pt-5'>
                    <h3 className='card-title align-items-start flex-column'>
                        <span className='card-label fw-bold fs-3 mb-1'>Gestion Type Colisage</span>
                    </h3>
                    <div className='card-toolbar'>

                        {/* begin::Search */}
                        <div className="input-group mb-3">
                            <label className='form-label fw-bolder text-dark fs-6' style={{ marginLeft: '200px' }} >code</label>
                            <input
                                placeholder=''
                                type='text'
                                autoComplete='off'
                    ...
                    <div className='card-toolbar'>
                        {/* begin::Search */}
                        <div className="input-group mb-3">
                            <label className='form-label fw-bolder text-dark fs-6 mb-3'>Intitule</label>
                            <input
                                placeholder=''
                                type='text'
                                autoComplete='off'
