...
const QualificationEmloyeesSchema = Yup.object().shape({
    code: Yup.number()
        .required('champs obligatoire '),
    Intitule: Yup.string()
        .required('champs obligatoire ')
})
export function QualificationEmployee() {
    const [, setLoading] = useState(false)
    const formik = useFormik({
        initialValues,
        validationSchema: QualificationEmloyeesSchema,
              ...
              <div className='card-header border-0 pt-5'>
                    <div className='card-toolbar'>
                        ...
                        <div className="input-group mb-3">
                            <label className='form-label fw-bolder text-dark fs-6' style={{ marginLeft: '500px' }}>code</label>
                            <input
                            placeholder=''
                                        type='text'
                                        autoComplete='off'
